...
<section id="portfolio" class="porftolio" style="margin-top: 50px;">
    ...
    <div
        ...
        <button onclick="view_more_porto_branding()" class="btn-s btn-4 btn-view-all" style="">View All</button>
    </div>
</section>
`;

function tampil_porto_branding() {
...
function view_more_porto_branding() {
    $(".isotopev2").children(".invisible").removeClass("invisible").addClass("visible")
    $(".btn-view-all").addClass('hidden')
    tampil_porto_branding();
}

$(".vlt-isotope-filters").children(".branding").on("click", function () {
    $(".isi-showcase").html(html_work_branding)
    setTimeout(() => {
        tampil_porto_branding();
    }, 100);
})